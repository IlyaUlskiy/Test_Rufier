...
txt_next = 'Начать'
txt_instruction = ('Данное приложение позволит вам с помощью теста Руфье провести певичную диагностику вашего здоровья.\n'
...
'а потом - за последние 15 секунд первой минуты период восстановление.\n'
'Важно! Если в процессе проведения испытания вы почувствуете сеюя плохо (появится головокружение, шум в\n'
...
txt_res2 = "удовлетворительная. Срочно обратитесь к врачу!"
